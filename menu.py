...
while place_order:
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    # quantity = input("How many", menu_selection_name, "would you like?")
                    # # another option is: 
                    quantity = input(f"What quantity of {menu_selection_name} would you like? \n"
                    ...
                    print(f"Your selection of {menu_selection} is not valid.")
            else:
    ...
    while True:
        ...
        match keep_ordering.lower():
            ...
            case _:
                print("Invalid selection. Please only type y or n. Please try again.")
...
for x in range(len(order_list)):
    ...
    item_name = order_list[x]["Item name"]
    price = order_list[x]["Price"]
    quantity = order_list[x]["Quantity"]
